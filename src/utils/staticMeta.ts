// Из за SSR не работает перезапись meta из webpack
// /favicon = assets в favicon plugin
export function faviconPluginStaticMeta() {
  return `<link rel="apple-touch-icon" sizes="57x57" href="/favicon/apple-touch-icon-57x57.png">
...
export function staticSCPmeta() {
  return `<meta http-equiv="Content-Security-Policy" content="
default-src 'self' https://ya-praktikum.tech 'unsafe-inline' 'unsafe-eval';
script-src 'self' https://ya-praktikum.tech 'unsafe-inline' 'unsafe-eval';
style-src 'self' 'unsafe-inline' 'unsafe-eval';
font-src 'self' 'unsafe-inline' 'unsafe-eval';
img-src 'self' https://ya-praktikum.tech 'unsafe-inline' 'unsafe-eval';
object-src 'none';
frame-src 'none';
">`
}
